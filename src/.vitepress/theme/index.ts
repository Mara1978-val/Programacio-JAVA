...
export default {
  ...
  enhanceApp(ctx: EnhanceAppContext) {
    ...
    // $withBase en Markdown: las páginas heredadas de los repos UF traen <img>
    // en HTML crudo, al que VitePress NO antepone el base del sitio. Escritas
    // como <img :src="$withBase('/img/...')"> resuelven bien bajo /programacion/.
    ctx.app.config.globalProperties.$withBase = withBase
