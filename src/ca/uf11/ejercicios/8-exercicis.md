...
<p align="center"> <img :src="$withBase('/img/uf11/exercici1.png')" alt="Exercici" width="700"> </p>

## Exercici 2

Modificar l'exercici 1 per a utilitzar el autoClose i per a mostrar per consola tots els atributs de cadascun.

<p align="center"> <img :src="$withBase('/img/uf11/exercici2.png')" alt="Exercici" width="700"> </p>
...
<p align="center"> <img :src="$withBase('/img/uf11/exercici4.png')" alt="Exercici" width="700"> </p>
...
<p align="center"> <img :src="$withBase('/img/uf11/exercici5.png')" alt="Exercici" width="700"> </p>
...
<p align="center"> <img :src="$withBase('/img/uf11/exercici6_1.png')" alt="Exercici" width="700"> </p> <p align="center"> <img :src="$withBase('/img/uf11/exercici6_2.png')" alt="Exercici" width="700"> </p>
...
<p align="center"> <img :src="$withBase('/img/uf11/exercici7.png')" alt="Exercici" width="700"> </p>
